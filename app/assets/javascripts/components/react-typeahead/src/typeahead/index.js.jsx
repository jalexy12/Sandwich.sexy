...
var Typeahead = React.createClass({
  ...
  getDefaultProps: function() {
    return {
      ...
      customListComponent: window.TypeaheadSelector
    };
  },
  ...
  setEntryText: function(value) {
    React.findDOMNode(this.refs.entry).value = value;
  ...
  _onOptionSelected: function(option, event) {
    var nEntry = React.findDOMNode(this.refs.entry);
    nEntry.focus();
  ...
  _onTextEntryUpdated: function() {
    var value = React.findDOMNode(this.refs.entry).value;

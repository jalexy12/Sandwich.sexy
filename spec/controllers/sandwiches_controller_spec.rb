...
RSpec.describe SandwichesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all sandwiches as @sandwiches" do
      ...
      expect(assigns(:sandwiches)).to eq([sandwich])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new sandwich as @sandwich" do
      ...
      expect(assigns(:sandwich)).to be_a_new(Sandwich)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created sandwich as @sandwich" do
        post :create, {:sandwich => valid_attributes}, valid_session
        expect(assigns(:sandwich)).to be_a(Sandwich)
        expect(assigns(:sandwich)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved sandwich as @sandwich" do
        post :create, {:sandwich => invalid_attributes}, valid_session
        expect(assigns(:sandwich)).to be_a_new(Sandwich)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested sandwich" do
        sandwich = Sandwich.create! valid_attributes
        put :update, {:id => sandwich.to_param, :sandwich => new_attributes}, valid_session
        sandwich.reload
    ...
    context "with invalid params" do
      it "assigns the sandwich as @sandwich" do
        sandwich = Sandwich.create! valid_attributes
        put :update, {:id => sandwich.to_param, :sandwich => invalid_attributes}, valid_session
        expect(assigns(:sandwich)).to eq(sandwich)
      end
